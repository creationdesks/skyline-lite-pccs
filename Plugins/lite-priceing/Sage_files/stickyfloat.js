        ...
        Sticky.prototype = {
            init : function(){
                ...
                $(w).ready(function(){
                    ...
                    setInterval(function(){  that.rePosition(true); }, 1000);
            ...
            **/
            rePosition : function(quick, force){
                ...
                if(areaScrollTop==0){
                    areaScrollTop=$(parent.document).scrollTop()
                    areaScrollTop=areaScrollTop-170;
                    if($(parent.window).height()<700)areaScrollTop=areaScrollTop-250;
                    if(areaScrollTop<0)areaScrollTop=10;
                }
                
                 if(areaScrollTop>2200){
                    areaScrollTop=2200
                }
